...
Toggle("Auto Farm",50,function(v)AutoFarm=v end)
Toggle("Auto Hoop",95,function(v)AutoHoop=v end)
Toggle("Walk Circle",140,function(v)WalkCircle=v end)
Toggle("Auto Jump",185,function(v)AutoJump=v end)
Toggle("Speed Boost",230,function(v)Speed=v end)
Toggle("ESP Orbs",275,function(v)ESP=v end)
...
if v:IsA("Part") and string.find(v.Name:lower(),"orb") then
